...
public class Generator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(120, 130, 260, 40);
        getContentPane().add(input);
        input.setBounds(240, 100, 140, 22);

        Len.setText("Length of number");
        getContentPane().add(Len);
        Len.setBounds(120, 100, 110, 16);
        getContentPane().add(output);
        output.setBounds(120, 180, 260, 22);
...
//            int len=Integer.valueOf(input.getText());

            int max=100; int min=1;
            Random rand=new Random();
            int out=min +rand.nextInt(max);
